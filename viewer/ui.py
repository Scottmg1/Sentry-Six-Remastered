...
class TeslaCamViewer(QMainWindow):
    ...
    def update_time_label(self, value):
        ...
        if hasattr(self, 'timeline') and hasattr(self.timeline, 'set_highlighted_event'):
            # The timeline will handle the highlighting logic internally
            self.timeline.set_highlighted_event(-1)  # Clear any existing highlight
            self.timeline._update_highlighted_event(value)  # Let the timeline update the highlight
